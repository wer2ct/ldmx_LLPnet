#Runs and instance of training for a chosen model. python3 training_instance_dynamic.py <training_path> <validation_path> <out_path>
...
def main():
    ...
    training_utils.run_train(model = classifier,
                             ...
                             log_dir = output_path, 
                             log_prefix = 'dynamic_run_extended', 
                             optimizer = 'Adam', 
                             lr = 0.001, 
                             max_epochs_ = 40,
